...
public struct BottomSheet<Content: View>: View {
    ...
    private var grayBackgroundOpacity: Double { isPresented ? (0.1 - Double(draggedOffset)/600) : 0 }
    ...
    public init(
        ...
        shadowColor:Color = Color(.systemBackground),
        ...
        GeometryReader { geometry in
            if geometry.size != .zero {
                ZStack {
                    ...
                    .shadow(color: shadowColor.opacity(0.2), radius: 8, x: 0, y: -3)
